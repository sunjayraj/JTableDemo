...
public class PagingDataModel extends AbstractTableModel  implements PagingModel {
	private static final long serialVersionUID = 20111216001L;
	...
	public int getRowCount() {
		return this.PAGE_SIZE;//data.length;
	}
